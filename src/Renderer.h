...
private:
    ...
    Microsoft::WRL::ComPtr<ID3D11VertexShader> voxelVs_,colorVs_,spriteVs_,uiVs_;
    ...
    Microsoft::WRL::ComPtr<ID3D11Buffer> frameCb_,overlayVb_,overlayIb_,lineVb_,environmentVb_,uiVb_;
    Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> textureArray_,sunTexture_,cloudsTexture_,iconsTexture_;
